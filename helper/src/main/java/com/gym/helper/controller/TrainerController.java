...
public class TrainerController {
    ...
    @GetMapping("/trainer-name/{traineeId}")
    public String getTrainerNameByTraineeId(@PathVariable Long traineeId) {
        return trainerService.getTrainerNameByTraineeId(traineeId);
    }
}
