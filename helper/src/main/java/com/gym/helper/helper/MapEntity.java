...
public class MapEntity {
    ...
    public static void mapTraineeProperties(Trainee initialTrainee, Trainee trainee){
        initialTrainee.setTrainer(trainee.getTrainer());
    ...
    public static void mapTraineeToTraineeDto(Trainee trainee, TraineeDto traineeDto){
        ...
        traineeDto.setTrainer(trainee.getTrainer());
    ...
    public static void mapTraineeDtoToTrainee(TraineeDto traineeDto, Trainee trainee){
        ...
        trainee.setTrainer(traineeDto.getTrainer());
    ...
    public static void mapExerciseProperties(Exercise initialExercise, Exercise exercise){
        initialExercise.setTrainer(exercise.getTrainer());
        initialExercise.setTrainee(exercise.getTrainee());
    ...
    public static ExerciseDto mapExerciseToExerciseDto(Exercise exercise, ExerciseDto exerciseDto){
        exerciseDto.setId(exercise.getId());
        exerciseDto.setTrainer(exercise.getTrainer());
        exerciseDto.setTrainee(exercise.getTrainee());
    ...
    public static Exercise mapExerciseDtoToExercise(ExerciseDto exerciseDto){
        Exercise exercise = new Exercise();
        exercise.setId(exerciseDto.getId());
        exercise.setTrainer(exerciseDto.getTrainer());
        exercise.setTrainee(exerciseDto.getTrainee());
